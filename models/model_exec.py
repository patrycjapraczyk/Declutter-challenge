...
class ModelExec:
    def __init__(self, include_comments=False, include_long_code=False):
        ...
        # features = self.extract_features(split_data['x_test'])
    ...
    def kfold_split(self):
        ...
        for train_index, test_index in kFold.split(self.data):
            ...
            # ensemble_result = self.ensemble_model(features_train, features_test, train_data['non-information'],
    ...
    def extract_features(self, x):
        ...
        code_comment_similarity = x.apply(lambda row:
        ...
        #comment_vectorised = self.vectorise_comment_data(x['comment'])

        features = [length_data, stopwords_num, code_comment_similarity, functional_types, java_tags]
        return features
    ...
    def vectorise_comment_data(self, comments):
        text_representation = TextRepresentationFactory.get_text_representation('BOW', comments)
        x_train_comments = text_representation.vectorize(comments)
        return comments
