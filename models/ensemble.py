...
class Ensemble:
    ...
    def get_ensemble_score(mode, features_train_text, features_train_notext,
                     features_test_text, features_test_notext, y_train, y_test, w1, w2):
        if mode == 'MAX_VOTE':
    ...
    def ensemble_averaging(features_train_text, features_train_notext,
        ...
        features_train_text, y_train_text = ImbalanceSampling.get_sampled_data('ADASYN', features_train_text,
                                                                         y_train)
        features_train_notext, y_train = ImbalanceSampling.get_sampled_data('ADASYN', features_train_notext, y_train)
